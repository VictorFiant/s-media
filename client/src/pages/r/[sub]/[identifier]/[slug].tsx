...
function PostPage() {
  ...
  return (
    <>
      ...
      <Link href={`/r/${sub}`}>
        <a>
          <div className="flex items-center w-full h-20 p-8 bg-green-600">
                  ...
                  {authenticated ? (
                    <div>
                      ...
                      <form onSubmit={submitComment}>
                        <textarea
                          className="w-full py-3 border border-gray-300 rounded focus:outline-none focus:border-gray-600"
                          onChange={(e) => setNewComment(e.target.value)}
                          value={newComment}
                        ></textarea>
                        <div className="flex justify-end">
                          <button
                            className="px-3 py-1 green button"
                    ...
                    <div className="flex items-center justify-between px-2 py-4 border border-gray-200 rounded">
                      ...
                      <div>
                        <Link href="/login">
                          <a className="px-4 py-1 mr-4 hollow green button">
                            Login
                          </a>
                        </Link>
                        <Link href="/register">
                          <a className="px-4 py-1 green button">Sigh-Up</a>
                        </Link>
                      </div>
                    </div>
                  )}

...
function create() {
  ...
  return (
    <div className="flex bg-white">
      <Head>
        <title>Create a Commuinity</title>
      </Head>
      <div
        className="h-screen bg-center bg-cover w-80"
        style={{ backgroundImage: "url('./../Images/tile2.jpg')" }}
      ></div>
        ...
        <div className="w-98">
          ...
          <form onSubmit={submitForm}>
            ...
            <div className="my-6">
              ...
              <p className="mb-2 text-xs text-gray-500">
                Community title represent the topic an you change it any time.
              </p>
              <input
                type="text"
                className={classNames(
            ...
            <div className="my-6">
              ...
              <p className="mb-2 text-xs text-gray-500">
                This is how new members come to understamd your community.
              </p>
              <textarea
                className={classNames(
                  "w-full p-3 border border-gray-200 rounded hover:border-gray-500",
            ...
            <div className="flex justify-end">
              <button className="px-4 py-1 text-sm font-semibold capitalize green button">
                Create Community
              </button>
            </div>
          </form>
